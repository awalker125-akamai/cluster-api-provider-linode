...
| `spec` _[AddressSetSpec](#addresssetspec)_ | spec is the desired state of the AddressSet |  | MinProperties: 1 <br />Required: \{\} <br /> |
| `status` _[AddressSetStatus](#addresssetstatus)_ | status is the observed state of the AddressSet |  | Optional: \{\} <br /> |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `ipv4` _string_ | ipv4 defines a list of IPv4 address strings |  | Optional: \{\} <br /> |
| `ipv6` _string_ | ipv6 defines a list of IPv6 address strings |  | Optional: \{\} <br /> |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `bucketName` _string_ | bucketName is the name of the bucket to grant access to. |  | MaxLength: 63 <br />MinLength: 3 <br />Required: \{\} <br /> |
| `permissions` _string_ | permissions is the permissions to grant to the bucket. |  | Enum: [read_only read_write] <br />Required: \{\} <br /> |
| `region` _string_ | region is the region of the bucket. |  | MinLength: 1 <br />Required: \{\} <br /> |
...
| `apiVersion` _string_ | APIVersion defines the versioned schema of this representation of an object.<br />Servers should convert recognized schemas to the latest internal value, and<br />may reject unrecognized values.<br />More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources |  | Optional: \{\} <br /> |
| `metadata` _[ObjectMeta](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.32/#objectmeta-v1-meta)_ | Refer to Kubernetes API documentation for fields of `metadata`. |  | Optional: \{\} <br /> |
| `spec` _[FirewallRuleSpec](#firewallrulespec)_ | spec is the desired state of the FirewallRule. |  | Required: \{\} <br /> |
| `status` _[FirewallRuleStatus](#firewallrulestatus)_ | status is the observed state of the FirewallRule. |  | Optional: \{\} <br /> |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `action` _string_ | action is the action to take when the rule matches. |  | Enum: [ACCEPT DROP] <br />Required: \{\} <br /> |
| `label` _string_ | label is the label of the rule. |  | MinLength: 3 <br />Required: \{\} <br /> |
| `description` _string_ | description is the description of the rule. |  | Optional: \{\} <br /> |
| `ports` _string_ | ports is the ports to apply the rule to. |  | Optional: \{\} <br /> |
| `protocol` _[NetworkProtocol](#networkprotocol)_ | protocol is the protocol to apply the rule to. |  | Enum: [TCP UDP ICMP IPENCAP] <br />Required: \{\} <br /> |
| `addresses` _[NetworkAddresses](#networkaddresses)_ | addresses is a list of addresses to apply the rule to. |  | Optional: \{\} <br /> |
| `addressSetRefs` _[ObjectReference](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.32/#objectreference-v1-core) array_ | addressSetRefs is a list of references to AddressSets as an alternative to<br />using Addresses but can be used in conjunction with it. |  | Optional: \{\} <br /> |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `name` _string_ | name of the generated Secret. If not set, the name is formatted as "\{name-of-obj-key\}-obj-key". |  | Optional: \{\} <br /> |
| `namespace` _string_ | namespace for the generated Secret. If not set, defaults to the namespace of the LinodeObjectStorageKey. |  | Optional: \{\} <br /> |
| `type` _[SecretType](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.32/#secrettype-v1-core)_ | type of the generated Secret. | Opaque | Enum: [Opaque addons.cluster.x-k8s.io/resource-set] <br />Optional: \{\} <br /> |
| `format` _object (keys:string, values:string)_ | format of the data stored in the generated Secret.<br />It supports Go template syntax and interpolating the following values: .AccessKey .SecretKey .BucketName .BucketEndpoint .S3Endpoint<br />If no format is supplied, then a generic one is used containing the values specified. |  | Optional: \{\} <br /> |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `enableSLAAC` _boolean_ | enableSLAAC is an option to enable SLAAC (Stateless Address Autoconfiguration) for the instance.<br />This is useful for IPv6 addresses, allowing the instance to automatically configure its own IPv6 address.<br />Defaults to false. |  | Optional: \{\} <br /> |
| `enableRanges` _boolean_ | enableRanges is an option to enable IPv6 ranges for the instance.<br />If set to true, the instance will have a range of IPv6 addresses.<br />This is useful for instances that require multiple IPv6 addresses.<br />Defaults to false. |  | Optional: \{\} <br /> |
| `isPublicIPv6` _boolean_ | isPublicIPv6 is an option to enable public IPv6 for the instance.<br />If set to true, the instance will have a publicly routable IPv6 range.<br />Defaults to false. |  | Optional: \{\} <br /> |
...
| `label` _string_ | label is the label of the interface. |  | MaxLength: 63 <br />MinLength: 3 <br />Optional: \{\} <br /> |
| `purpose` _[ConfigInterfacePurpose](#configinterfacepurpose)_ | purpose is the purpose of the interface. |  | Optional: \{\} <br /> |
| `primary` _boolean_ | primary is a boolean indicating whether the interface is primary. |  | Optional: \{\} <br /> |
| `subnetId` _integer_ | subnetId is the ID of the subnet to use for the interface. |  | Optional: \{\} <br /> |
| `ipv4` _[VPCIPv4](#vpcipv4)_ | ipv4 is the IPv4 configuration for the interface. |  | Optional: \{\} <br /> |
| `ipRanges` _string array_ | ipRanges is a list of IPv4 ranges to assign to the interface. |  | Optional: \{\} <br /> |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `kernel` _string_ | kernel is a Kernel ID to boot a Linode with. (e.g linode/latest-64bit). |  | Optional: \{\} <br /> |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `diskID` _integer_ | diskID is the linode assigned ID of the disk. |  | Optional: \{\} <br /> |
...
| `label` _string_ | label for the instance disk, if nothing is provided, it will match the device name. |  | Optional: \{\} <br /> |
| `filesystem` _string_ | filesystem of disk to provision, the default disk filesystem is "ext4". |  | Enum: [raw swap ext3 ext4 initrd] <br />Optional: \{\} <br /> |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `sdb` _[InstanceDisk](#instancedisk)_ | sdb is a disk for the instance. |  | Optional: \{\} <br /> |
| `sdc` _[InstanceDisk](#instancedisk)_ | sdc is a disk for the instance. |  | Optional: \{\} <br /> |
| `sdd` _[InstanceDisk](#instancedisk)_ | sdd is a disk for the instance. |  | Optional: \{\} <br /> |
| `sde` _[InstanceDisk](#instancedisk)_ | sde is a disk for the instance. |  | Optional: \{\} <br /> |
| `sdf` _[InstanceDisk](#instancedisk)_ | sdf is a disk for the instance. |  | Optional: \{\} <br /> |
| `sdg` _[InstanceDisk](#instancedisk)_ | sdg is a disk for the instance. |  | Optional: \{\} <br /> |
| `sdh` _[InstanceDisk](#instancedisk)_ | sdh is a disk for the instance. |  | Optional: \{\} <br /> |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `ipv4` _boolean_ | ipv4 is the IPv4 default route for the interface. |  | Optional: \{\} <br /> |
| `ipv6` _boolean_ | ipv6 is the IPv6 default route for the interface. |  | Optional: \{\} <br /> |
...
| `apiVersion` _string_ | APIVersion defines the versioned schema of this representation of an object.<br />Servers should convert recognized schemas to the latest internal value, and<br />may reject unrecognized values.<br />More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources |  | Optional: \{\} <br /> |
| `metadata` _[ObjectMeta](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.32/#objectmeta-v1-meta)_ | Refer to Kubernetes API documentation for fields of `metadata`. |  | Optional: \{\} <br /> |
| `spec` _[LinodeClusterSpec](#linodeclusterspec)_ | spec is the desired state of the LinodeCluster. |  | Required: \{\} <br /> |
| `status` _[LinodeClusterStatus](#linodeclusterstatus)_ | status is the observed state of the LinodeCluster. |  | Optional: \{\} <br /> |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `region` _string_ | region the LinodeCluster lives in. |  | MinLength: 1 <br />Required: \{\} <br /> |
| `controlPlaneEndpoint` _[APIEndpoint](#apiendpoint)_ | controlPlaneEndpoint represents the endpoint used to communicate with the LinodeCluster control plane<br />If ControlPlaneEndpoint is unset then the Nodebalancer ip will be used. |  | Optional: \{\} <br /> |
| `network` _[NetworkSpec](#networkspec)_ | network encapsulates all things related to Linode network. |  | Optional: \{\} <br /> |
| `vpcRef` _[ObjectReference](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.32/#objectreference-v1-core)_ | vpcRef is a reference to a VPC object. This makes the Linodes use the specified VPC. |  | Optional: \{\} <br /> |
| `vpcID` _integer_ | vpcID is the ID of an existing VPC in Linode. |  | Optional: \{\} <br /> |
| `nodeBalancerFirewallRef` _[ObjectReference](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.32/#objectreference-v1-core)_ | nodeBalancerFirewallRef is a reference to a NodeBalancer Firewall object. This makes the linode use the specified NodeBalancer Firewall. |  | Optional: \{\} <br /> |
| `objectStore` _[ObjectStore](#objectstore)_ | objectStore defines a supporting Object Storage bucket for cluster operations. This is currently used for<br />bootstrapping (e.g. Cloud-init). |  | Optional: \{\} <br /> |
| `credentialsRef` _[SecretReference](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.32/#secretreference-v1-core)_ | credentialsRef is a reference to a Secret that contains the credentials to use for provisioning this cluster. If not<br /> supplied, then the credentials of the controller will be used. |  | Optional: \{\} <br /> |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `conditions` _[Condition](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.32/#condition-v1-meta) array_ | conditions define the current service state of the LinodeCluster. |  | Optional: \{\} <br /> |
| `ready` _boolean_ | ready denotes that the cluster (infrastructure) is ready. |  | Optional: \{\} <br /> |
| `failureReason` _string_ | failureReason will be set in the event that there is a terminal problem<br />reconciling the LinodeCluster and will contain a succinct value suitable<br />for machine interpretation. |  | Optional: \{\} <br /> |
| `failureMessage` _string_ | failureMessage will be set in the event that there is a terminal problem<br />reconciling the LinodeCluster and will contain a more verbose string suitable<br />for logging and human consumption. |  | Optional: \{\} <br /> |
...
| `apiVersion` _string_ | APIVersion defines the versioned schema of this representation of an object.<br />Servers should convert recognized schemas to the latest internal value, and<br />may reject unrecognized values.<br />More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources |  | Optional: \{\} <br /> |
| `metadata` _[ObjectMeta](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.32/#objectmeta-v1-meta)_ | Refer to Kubernetes API documentation for fields of `metadata`. |  | Optional: \{\} <br /> |
| `spec` _[LinodeClusterTemplateSpec](#linodeclustertemplatespec)_ | spec is the desired state of the LinodeClusterTemplate. |  | Optional: \{\} <br /> |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `spec` _[LinodeClusterSpec](#linodeclusterspec)_ | spec is the specification of the LinodeCluster. |  | Required: \{\} <br /> |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `template` _[LinodeClusterTemplateResource](#linodeclustertemplateresource)_ | template defines the specification for a LinodeCluster. |  | Required: \{\} <br /> |
...
| `apiVersion` _string_ | APIVersion defines the versioned schema of this representation of an object.<br />Servers should convert recognized schemas to the latest internal value, and<br />may reject unrecognized values.<br />More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources |  | Optional: \{\} <br /> |
| `metadata` _[ObjectMeta](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.32/#objectmeta-v1-meta)_ | Refer to Kubernetes API documentation for fields of `metadata`. |  | Optional: \{\} <br /> |
| `spec` _[LinodeFirewallSpec](#linodefirewallspec)_ | spec is the desired state of the LinodeFirewall. |  | MinProperties: 1 <br />Required: \{\} <br /> |
| `status` _[LinodeFirewallStatus](#linodefirewallstatus)_ | status is the observed state of the LinodeFirewall. |  | Optional: \{\} <br /> |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `firewallID` _integer_ | firewallID is the ID of the Firewall. |  | Optional: \{\} <br /> |
| `enabled` _boolean_ | enabled determines if the Firewall is enabled. Defaults to false if not defined. | false | Optional: \{\} <br /> |
| `inboundRules` _[FirewallRuleSpec](#firewallrulespec) array_ | inboundRules is a list of FirewallRules that will be applied to the Firewall. |  | Optional: \{\} <br /> |
| `inboundRuleRefs` _[ObjectReference](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.32/#objectreference-v1-core) array_ | inboundRuleRefs is a list of references to FirewallRules as an alternative to<br />using InboundRules but can be used in conjunction with it |  | Optional: \{\} <br /> |
| `inboundPolicy` _string_ | inboundPolicy determines if traffic by default should be ACCEPTed or DROPped. Defaults to ACCEPT if not defined. | ACCEPT | Enum: [ACCEPT DROP] <br />Optional: \{\} <br /> |
| `outboundRules` _[FirewallRuleSpec](#firewallrulespec) array_ | outboundRules is a list of FirewallRules that will be applied to the Firewall. |  | Optional: \{\} <br /> |
| `outboundRuleRefs` _[ObjectReference](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.32/#objectreference-v1-core) array_ | outboundRuleRefs is a list of references to FirewallRules as an alternative to<br />using OutboundRules but can be used in conjunction with it |  | Optional: \{\} <br /> |
| `outboundPolicy` _string_ | outboundPolicy determines if traffic by default should be ACCEPTed or DROPped. Defaults to ACCEPT if not defined. | ACCEPT | Enum: [ACCEPT DROP] <br />Optional: \{\} <br /> |
| `credentialsRef` _[SecretReference](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.32/#secretreference-v1-core)_ | credentialsRef is a reference to a Secret that contains the credentials to use for provisioning this Firewall. If not<br />supplied then the credentials of the controller will be used. |  | Optional: \{\} <br /> |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `conditions` _[Condition](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.32/#condition-v1-meta) array_ | conditions define the current service state of the LinodeFirewall. |  | Optional: \{\} <br /> |
| `ready` _boolean_ | ready is true when the provider resource is ready. | false | Optional: \{\} <br /> |
...
| `apiVersion` _string_ | APIVersion defines the versioned schema of this representation of an object.<br />Servers should convert recognized schemas to the latest internal value, and<br />may reject unrecognized values.<br />More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources |  | Optional: \{\} <br /> |
| `metadata` _[ObjectMeta](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.32/#objectmeta-v1-meta)_ | Refer to Kubernetes API documentation for fields of `metadata`. |  | Optional: \{\} <br /> |
| `spec` _[LinodeMachineSpec](#linodemachinespec)_ | spec defines the specification of desired behavior for the LinodeMachine. |  | Required: \{\} <br /> |
| `status` _[LinodeMachineStatus](#linodemachinestatus)_ | status defines the observed state of LinodeMachine. |  | Optional: \{\} <br /> |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `providerID` _string_ | providerID is the unique identifier as specified by the cloud provider. |  | Optional: \{\} <br /> |
| `instanceID` _integer_ | instanceID is the Linode instance ID for this machine. |  | Optional: \{\} <br /> |
| `region` _string_ | region is the Linode region to create the instance in. |  | MinLength: 1 <br />Required: \{\} <br /> |
| `type` _string_ | type is the Linode instance type to create. |  | MinLength: 1 <br />Required: \{\} <br /> |
| `group` _string_ | group is the Linode group to create the instance in. |  | Optional: \{\} <br /> |
| `rootPass` _string_ | rootPass is the root password for the instance. |  | Optional: \{\} <br /> |
| `authorizedKeys` _string array_ | authorizedKeys is a list of SSH public keys to add to the instance. |  | Optional: \{\} <br /> |
| `authorizedUsers` _string array_ | authorizedUsers is a list of usernames to add to the instance. |  | Optional: \{\} <br /> |
| `backupID` _integer_ | backupID is the ID of the backup to restore the instance from. |  | Optional: \{\} <br /> |
| `image` _string_ | image is the Linode image to use for the instance. |  | Optional: \{\} <br /> |
| `interfaces` _[InstanceConfigInterfaceCreateOptions](#instanceconfiginterfacecreateoptions) array_ | interfaces is a list of legacy network interfaces to use for the instance. |  | Optional: \{\} <br /> |
| `linodeInterfaces` _[LinodeInterfaceCreateOptions](#linodeinterfacecreateoptions) array_ | linodeInterfaces is a list of Linode network interfaces to use for the instance. Requires Linode Interfaces beta opt-in to use. |  | Optional: \{\} <br /> |
| `backupsEnabled` _boolean_ | backupsEnabled is a boolean indicating whether backups should be enabled for the instance. |  | Optional: \{\} <br /> |
| `privateIP` _boolean_ | privateIP is a boolean indicating whether the instance should have a private IP address. |  | Optional: \{\} <br /> |
| `tags` _string array_ | tags is a list of tags to apply to the Linode instance. |  | Optional: \{\} <br /> |
| `firewallID` _integer_ | firewallID is the id of the cloud firewall to apply to the Linode Instance |  | Optional: \{\} <br /> |
| `osDisk` _[InstanceDisk](#instancedisk)_ | osDisk is a configuration for the root disk that includes the OS,<br />if not specified, this defaults to whatever space is not taken up by the DataDisks |  | Optional: \{\} <br /> |
| `dataDisks` _[InstanceDisks](#instancedisks)_ | dataDisks is a map of any additional disks to add to an instance,<br />The sum of these disks + the OSDisk must not be more than allowed on a linodes plan |  | Optional: \{\} <br /> |
| `diskEncryption` _string_ | diskEncryption determines if the disks of the instance should be encrypted. The default is disabled. |  | Enum: [enabled disabled] <br />Optional: \{\} <br /> |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `conditions` _[Condition](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.32/#condition-v1-meta) array_ | conditions define the current service state of the LinodeMachine. |  | Optional: \{\} <br /> |
| `ready` _boolean_ | ready is true when the provider resource is ready. | false | Optional: \{\} <br /> |
| `addresses` _MachineAddress array_ | addresses contains the Linode instance associated addresses. |  | Optional: \{\} <br /> |
| `cloudinitMetadataSupport` _boolean_ | cloudinitMetadataSupport determines whether to use cloud-init or not.<br />Deprecated: stackscript are no longer in use, so this field is not used. | true | Optional: \{\} <br /> |
| `instanceState` _[InstanceStatus](#instancestatus)_ | instanceState is the state of the Linode instance for this machine. |  | Optional: \{\} <br /> |
...
| `tags` _string array_ | tags are the tags applied to the Linode Machine. |  | Optional: \{\} <br /> |
...
| `apiVersion` _string_ | APIVersion defines the versioned schema of this representation of an object.<br />Servers should convert recognized schemas to the latest internal value, and<br />may reject unrecognized values.<br />More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources |  | Optional: \{\} <br /> |
| `metadata` _[ObjectMeta](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.32/#objectmeta-v1-meta)_ | Refer to Kubernetes API documentation for fields of `metadata`. |  | Optional: \{\} <br /> |
| `spec` _[LinodeMachineTemplateSpec](#linodemachinetemplatespec)_ | spec is the desired state of the LinodeMachineTemplate. |  | Optional: \{\} <br /> |
| `status` _[LinodeMachineTemplateStatus](#linodemachinetemplatestatus)_ | status is the observed state of the LinodeMachineTemplate. |  | Optional: \{\} <br /> |
...
| `apiVersion` _string_ | APIVersion defines the versioned schema of this representation of an object.<br />Servers should convert recognized schemas to the latest internal value, and<br />may reject unrecognized values.<br />More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources |  | Optional: \{\} <br /> |
| `metadata` _[ListMeta](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.32/#listmeta-v1-meta)_ | Refer to Kubernetes API documentation for fields of `metadata`. |  | Optional: \{\} <br /> |
| `items` _[LinodeMachineTemplate](#linodemachinetemplate) array_ | items is a list of LinodeMachineTemplate. |  | Optional: \{\} <br /> |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `spec` _[LinodeMachineSpec](#linodemachinespec)_ | spec is the specification of the desired behavior of the machine. |  | Required: \{\} <br /> |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `template` _[LinodeMachineTemplateResource](#linodemachinetemplateresource)_ | template defines the specification for a LinodeMachine. |  | Required: \{\} <br /> |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `port` _integer_ | port configured on the NodeBalancer. It must be valid port range (1-65535). |  | Maximum: 65535 <br />Minimum: 1 <br />Required: \{\} <br /> |
| `nodeBalancerConfigID` _integer_ | nodeBalancerConfigID is the config ID of port's NodeBalancer config. |  | Optional: \{\} <br /> |
...
| `apiVersion` _string_ | APIVersion defines the versioned schema of this representation of an object.<br />Servers should convert recognized schemas to the latest internal value, and<br />may reject unrecognized values.<br />More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources |  | Optional: \{\} <br /> |
| `metadata` _[ObjectMeta](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.32/#objectmeta-v1-meta)_ | Refer to Kubernetes API documentation for fields of `metadata`. |  | Optional: \{\} <br /> |
| `spec` _[LinodeObjectStorageBucketSpec](#linodeobjectstoragebucketspec)_ | spec is the desired state of the LinodeObjectStorageBucket. |  | Required: \{\} <br /> |
| `status` _[LinodeObjectStorageBucketStatus](#linodeobjectstoragebucketstatus)_ | status is the observed state of the LinodeObjectStorageBucket. |  | Optional: \{\} <br /> |
...
| `apiVersion` _string_ | APIVersion defines the versioned schema of this representation of an object.<br />Servers should convert recognized schemas to the latest internal value, and<br />may reject unrecognized values.<br />More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources |  | Optional: \{\} <br /> |
| `metadata` _[ListMeta](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.32/#listmeta-v1-meta)_ | Refer to Kubernetes API documentation for fields of `metadata`. |  | Optional: \{\} <br /> |
| `items` _[LinodeObjectStorageBucket](#linodeobjectstoragebucket) array_ | items is a list of LinodeObjectStorageBucket. |  | Optional: \{\} <br /> |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `region` _string_ | region is the ID of the Object Storage region for the bucket. |  | MinLength: 1 <br />Required: \{\} <br /> |
| `acl` _[ObjectStorageACL](#objectstorageacl)_ | acl sets the Access Control Level of the bucket using a canned ACL string | private | Enum: [private public-read authenticated-read public-read-write] <br />Optional: \{\} <br /> |
| `corsEnabled` _boolean_ | corsEnabled enables for all origins in the bucket .If set to false, CORS is disabled for all origins in the bucket | true | Optional: \{\} <br /> |
| `credentialsRef` _[SecretReference](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.32/#secretreference-v1-core)_ | credentialsRef is a reference to a Secret that contains the credentials to use for provisioning the bucket.<br />If not supplied then the credentials of the controller will be used. |  | Optional: \{\} <br /> |
| `accessKeyRef` _[ObjectReference](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.32/#objectreference-v1-core)_ | accessKeyRef is a reference to a LinodeObjectStorageBucketKey for the bucket. |  | Optional: \{\} <br /> |
| `forceDeleteBucket` _boolean_ | forceDeleteBucket enables the object storage bucket used to be deleted even if it contains objects. |  | Optional: \{\} <br /> |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `conditions` _[Condition](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.32/#condition-v1-meta) array_ | conditions define the current service state of the LinodeObjectStorageBucket. |  | Optional: \{\} <br /> |
| `ready` _boolean_ | ready denotes that the bucket has been provisioned along with access keys. | false | Optional: \{\} <br /> |
| `failureMessage` _string_ | failureMessage will be set in the event that there is a terminal problem<br />reconciling the Object Storage Bucket and will contain a verbose string<br />suitable for logging and human consumption. |  | Optional: \{\} <br /> |
| `failureReason` _string_ | failureReason will be set in the event that there is a terminal problem<br />reconciling the Object Storage Bucket and will contain a succinct value suitable<br />for machine interpretation. |  | Optional: \{\} <br /> |
| `hostname` _string_ | hostname is the address assigned to the bucket. |  | Optional: \{\} <br /> |
| `creationTime` _[Time](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.32/#time-v1-meta)_ | creationTime specifies the creation timestamp for the bucket. |  | Optional: \{\} <br /> |
...
| `apiVersion` _string_ | APIVersion defines the versioned schema of this representation of an object.<br />Servers should convert recognized schemas to the latest internal value, and<br />may reject unrecognized values.<br />More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources |  | Optional: \{\} <br /> |
| `metadata` _[ObjectMeta](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.32/#objectmeta-v1-meta)_ | Refer to Kubernetes API documentation for fields of `metadata`. |  | Optional: \{\} <br /> |
| `spec` _[LinodeObjectStorageKeySpec](#linodeobjectstoragekeyspec)_ | spec is the desired state of the LinodeObjectStorageKey. |  | Required: \{\} <br /> |
| `status` _[LinodeObjectStorageKeyStatus](#linodeobjectstoragekeystatus)_ | status is the observed state of the LinodeObjectStorageKey. |  | Optional: \{\} <br /> |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `bucketAccess` _[BucketAccessRef](#bucketaccessref) array_ | bucketAccess is the list of object storage bucket labels which can be accessed using the key |  | MinItems: 1 <br />Required: \{\} <br /> |
| `credentialsRef` _[SecretReference](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.32/#secretreference-v1-core)_ | credentialsRef is a reference to a Secret that contains the credentials to use for generating access keys.<br />If not supplied, then the credentials of the controller will be used. |  | Optional: \{\} <br /> |
| `keyGeneration` _integer_ | keyGeneration may be modified to trigger a rotation of the access key. | 0 | Optional: \{\} <br /> |
| `generatedSecret` _[GeneratedSecret](#generatedsecret)_ | generatedSecret configures the Secret to generate containing access key details. |  | Required: \{\} <br /> |
| `secretType` _[SecretType](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.32/#secrettype-v1-core)_ | secretType instructs the controller what type of secret to generate containing access key details.<br />Deprecated: secretType is no longer supported, Use generatedSecret.type. |  | Enum: [Opaque addons.cluster.x-k8s.io/resource-set] <br />Optional: \{\} <br /> |
| `secretDataFormat` _object (keys:string, values:string)_ | secretDataFormat instructs the controller how to format the data stored in the secret containing access key details.<br />Deprecated: secretDataFormat is no longer supported, please use generatedSecret.format. |  | Optional: \{\} <br /> |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `conditions` _[Condition](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.32/#condition-v1-meta) array_ | conditions define the current service state of the LinodeObjectStorageKey. |  | Optional: \{\} <br /> |
| `ready` _boolean_ | ready denotes that the key has been provisioned. | false | Optional: \{\} <br /> |
| `failureMessage` _string_ | failureMessage will be set in the event that there is a terminal problem<br />reconciling the Object Storage Key and will contain a verbose string<br />suitable for logging and human consumption. |  | Optional: \{\} <br /> |
| `failureReason` _string_ | failureReason will be set in the event that there is a terminal problem<br />reconciling the Object Storage Key and will contain a succinct value suitable<br />for machine interpretation. |  | Optional: \{\} <br /> |
| `creationTime` _[Time](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.32/#time-v1-meta)_ | creationTime specifies the creation timestamp for the secret. |  | Optional: \{\} <br /> |
| `lastKeyGeneration` _integer_ | lastKeyGeneration tracks the last known value of .spec.keyGeneration. |  | Optional: \{\} <br /> |
| `accessKeyRef` _integer_ | accessKeyRef stores the ID for Object Storage key provisioned. |  | Optional: \{\} <br /> |
...
| `apiVersion` _string_ | APIVersion defines the versioned schema of this representation of an object.<br />Servers should convert recognized schemas to the latest internal value, and<br />may reject unrecognized values.<br />More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources |  | Optional: \{\} <br /> |
| `metadata` _[ObjectMeta](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.32/#objectmeta-v1-meta)_ | Refer to Kubernetes API documentation for fields of `metadata`. |  | Optional: \{\} <br /> |
| `spec` _[LinodePlacementGroupSpec](#linodeplacementgroupspec)_ | spec is the desired state of the LinodePlacementGroup. |  | Required: \{\} <br /> |
| `status` _[LinodePlacementGroupStatus](#linodeplacementgroupstatus)_ | status is the observed state of the LinodePlacementGroup. |  | Optional: \{\} <br /> |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `pgID` _integer_ | pgID is the ID of the PlacementGroup. |  | Optional: \{\} <br /> |
| `region` _string_ | region is the Linode region to create the PlacementGroup in. |  | MinLength: 1 <br />Required: \{\} <br /> |
| `placementGroupPolicy` _string_ | placementGroupPolicy defines the policy for the PlacementGroup. | strict | Enum: [strict flexible] <br />Optional: \{\} <br /> |
| `placementGroupType` _string_ | placementGroupType defines the type of the PlacementGroup. | anti_affinity:local | Enum: [anti_affinity:local] <br />Optional: \{\} <br /> |
| `credentialsRef` _[SecretReference](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.32/#secretreference-v1-core)_ | credentialsRef is a reference to a Secret that contains the credentials to use for provisioning this PlacementGroup.<br />If not supplied, then the credentials of the controller will be used. |  | Optional: \{\} <br /> |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `conditions` _[Condition](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.32/#condition-v1-meta) array_ | conditions define the current service state of the LinodePlacementGroup. |  | Optional: \{\} <br /> |
| `ready` _boolean_ | ready is true when the provider resource is ready. | false | Optional: \{\} <br /> |
...
| `apiVersion` _string_ | APIVersion defines the versioned schema of this representation of an object.<br />Servers should convert recognized schemas to the latest internal value, and<br />may reject unrecognized values.<br />More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources |  | Optional: \{\} <br /> |
| `metadata` _[ObjectMeta](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.32/#objectmeta-v1-meta)_ | Refer to Kubernetes API documentation for fields of `metadata`. |  | Optional: \{\} <br /> |
| `spec` _[LinodeVPCSpec](#linodevpcspec)_ | spec is the desired state of the LinodeVPC. |  | Required: \{\} <br /> |
| `status` _[LinodeVPCStatus](#linodevpcstatus)_ | status is the observed state of the LinodeVPC. |  | Optional: \{\} <br /> |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `vpcID` _integer_ | vpcID is the ID of the VPC. |  | Optional: \{\} <br /> |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `conditions` _[Condition](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.32/#condition-v1-meta) array_ | conditions define the current service state of the LinodeVPC. |  | Optional: \{\} <br /> |
| `ready` _boolean_ | ready is true when the provider resource is ready. | false | Optional: \{\} <br /> |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `loadBalancerType` _string_ | loadBalancerType is the type of load balancer to use, defaults to NodeBalancer if not otherwise set. | NodeBalancer | Enum: [NodeBalancer dns external] <br />Optional: \{\} <br /> |
| `dnsProvider` _string_ | dnsProvider is the provider who manages the domain.<br />Ignored if the LoadBalancerType is set to anything other than dns<br />If not set, defaults linode dns |  | Enum: [linode akamai] <br />Optional: \{\} <br /> |
| `dnsRootDomain` _string_ | dnsRootDomain is the root domain used to create a DNS entry for the control-plane endpoint.<br />Ignored if the LoadBalancerType is set to anything other than dns |  | Optional: \{\} <br /> |
| `dnsUniqueIdentifier` _string_ | dnsUniqueIdentifier is the unique identifier for the DNS. This let clusters with the same name have unique<br />DNS record<br />Ignored if the LoadBalancerType is set to anything other than dns<br />If not set, CAPL will create a unique identifier for you |  | Optional: \{\} <br /> |
| `dnsTTLsec` _integer_ | dnsTTLsec is the TTL for the domain record<br />Ignored if the LoadBalancerType is set to anything other than dns<br />If not set, defaults to 30 |  | Optional: \{\} <br /> |
| `dnsSubDomainOverride` _string_ | dnsSubDomainOverride is used to override CAPL's construction of the controlplane endpoint<br />If set, this will override the DNS subdomain from <clustername>-<uniqueid>.<rootdomain> to <overridevalue>.<rootdomain> |  | Optional: \{\} <br /> |
| `apiserverLoadBalancerPort` _integer_ | apiserverLoadBalancerPort used by the api server. It must be valid ports range (1-65535).<br />If omitted, default value is 6443. |  | Maximum: 65535 <br />Minimum: 1 <br />Optional: \{\} <br /> |
| `nodeBalancerID` _integer_ | nodeBalancerID is the id of NodeBalancer. |  | Optional: \{\} <br /> |
| `nodeBalancerFirewallID` _integer_ | nodeBalancerFirewallID is the id of NodeBalancer Firewall. |  | Optional: \{\} <br /> |
| `apiserverNodeBalancerConfigID` _integer_ | apiserverNodeBalancerConfigID is the config ID of api server NodeBalancer config. |  | Optional: \{\} <br /> |
| `additionalPorts` _[LinodeNBPortConfig](#linodenbportconfig) array_ | additionalPorts contains list of ports to be configured with NodeBalancer. |  | Optional: \{\} <br /> |
| `subnetName` _string_ | subnetName is the name/label of the VPC subnet to be used by the cluster |  | Optional: \{\} <br /> |
| `useVlan` _boolean_ | useVlan provisions a cluster that uses VLANs instead of VPCs. IPAM is managed internally. |  | Optional: \{\} <br /> |
| `nodeBalancerBackendIPv4Range` _string_ | nodeBalancerBackendIPv4Range is the subnet range we want to provide for creating nodebalancer in VPC.<br />example: 10.10.10.0/30 |  | Optional: \{\} <br /> |
| `enableVPCBackends` _boolean_ | enableVPCBackends toggles VPC-scoped NodeBalancer and VPC backend IP usage.<br />If set to false (default), the NodeBalancer will not be created in a VPC and<br />backends will use Linode private IPs. If true, the NodeBalancer will be<br />created in the configured VPC (when VPCRef or VPCID is set) and backends<br />will use VPC IPs. | false | Optional: \{\} <br /> |
...
| `credentialsRef` _[SecretReference](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.32/#secretreference-v1-core)_ | credentialsRef is a reference to a Secret that contains the credentials to use for accessing the Cluster Object Store. |  | Optional: \{\} <br /> |
| `secondaryCredentialsRef` _[SecretReference](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.32/#secretreference-v1-core)_ | secondaryCredentialsRef is an optional reference to a Secret that contains credentials for a secondary<br />Cluster Object Store. It is used only when the primary Object Store cannot upload bootstrap data and<br />generate a non-empty presigned URL. |  | Optional: \{\} <br /> |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `ipv4` _[PublicInterfaceIPv4CreateOptions](#publicinterfaceipv4createoptions)_ | ipv4 is the IPv4 configuration for the public interface. |  | Optional: \{\} <br /> |
| `ipv6` _[PublicInterfaceIPv6CreateOptions](#publicinterfaceipv6createoptions)_ | ipv6 is the IPv6 configuration for the public interface. |  | Optional: \{\} <br /> |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `address` _string_ | address is the IPv4 address for the public interface. |  | MinLength: 1 <br />Required: \{\} <br /> |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `addresses` _[PublicInterfaceIPv4AddressCreateOptions](#publicinterfaceipv4addresscreateoptions) array_ | addresses is the IPv4 addresses for the public interface. |  | Optional: \{\} <br /> |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `ranges` _[PublicInterfaceIPv6RangeCreateOptions](#publicinterfaceipv6rangecreateoptions) array_ | ranges is the IPv6 ranges for the public interface. |  | Optional: \{\} <br /> |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `vpc` _string_ | vpc is the ID of the VPC to use for the interface. |  | Optional: \{\} <br /> |
| `nat1to1` _string_ | nat1to1 is the NAT 1:1 address for the interface. |  | Optional: \{\} <br /> |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `addresses` _[VPCInterfaceIPv4AddressCreateOptions](#vpcinterfaceipv4addresscreateoptions) array_ | addresses is the IPv4 addresses for the interface. |  | Optional: \{\} <br /> |
| `ranges` _[VPCInterfaceIPv4RangeCreateOptions](#vpcinterfaceipv4rangecreateoptions) array_ | ranges is the IPv4 ranges for the interface. |  | Optional: \{\} <br /> |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `range` _string_ | range is the IPv4 range for the interface. |  | MinLength: 1 <br />Required: \{\} <br /> |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `range` _string_ | range is the IPv6 range for the interface. |  | MinLength: 1 <br />Required: \{\} <br /> |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `label` _string_ | label is the label of the subnet. |  | MaxLength: 63 <br />MinLength: 3 <br />Optional: \{\} <br /> |
| `ipv4` _string_ | ipv4 is the IPv4 address range of the subnet. |  | Optional: \{\} <br /> |
| `ipv6` _VPCIPv6Range array_ | ipv6 is a list of IPv6 ranges allocated to the subnet.<br />Once ranges are allocated based on the IPv6Range field, they will be<br />added to this field. |  | Optional: \{\} <br /> |
| `ipv6Range` _[VPCSubnetCreateOptionsIPv6](#vpcsubnetcreateoptionsipv6) array_ | ipv6Range is a list of IPv6 ranges to allocate to the subnet.<br />If not specified, the subnet will not have an IPv6 range allocated.<br />Once ranges are allocated, they will be added to the IPv6 field. |  | Optional: \{\} <br /> |
| `subnetID` _integer_ | subnetID is subnet id for the subnet |  | Optional: \{\} <br /> |
| `retain` _boolean_ | retain allows you to keep the Subnet after the LinodeVPC object is deleted.<br />This is only applicable when the parent VPC has retain set to true. | false | Optional: \{\} <br /> |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `range` _string_ | range is the IPv6 prefix for the subnet. |  | Optional: \{\} <br /> |
