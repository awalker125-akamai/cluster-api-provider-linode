...
func (in *FirewallRuleSpec) DeepCopyInto(out *FirewallRuleSpec) {
	*out = *in
	...
	if in.AddressSetRefs != nil {
		in, out := &in.AddressSetRefs, &out.AddressSetRefs
...
func (in *LinodeInterfaceCreateOptions) DeepCopyInto(out *LinodeInterfaceCreateOptions) {
	*out = *in
	...
	if in.FirewallIDLegacy != nil {
		in, out := &in.FirewallIDLegacy, &out.FirewallIDLegacy
		*out = new(int)
		**out = **in
	}
	...
	if in.DefaultRouteLegacy != nil {
		in, out := &in.DefaultRouteLegacy, &out.DefaultRouteLegacy
		*out = new(InterfaceDefaultRoute)
		(*in).DeepCopyInto(*out)
	}
	if in.Public != nil {
	...
	if in.RDMAVPC != nil {
		in, out := &in.RDMAVPC, &out.RDMAVPC
		*out = new(RDMAVPCInterfaceSpec)
		**out = **in
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LinodeMachineTemplateStatus) DeepCopyInto(out *LinodeMachineTemplateStatus) {
	*out = *in
	if in.Conditions != nil {
		in, out := &in.Conditions, &out.Conditions
		*out = make([]metav1.Condition, len(*in))
...
func (in *LinodeMachineTemplateStatus) DeepCopy() *LinodeMachineTemplateStatus {
	if in == nil {
		return nil
	}
	out := new(LinodeMachineTemplateStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ObjectStore) DeepCopyInto(out *ObjectStore) {
	*out = *in
	...
	if in.SecondaryCredentialsRef != nil {
		in, out := &in.SecondaryCredentialsRef, &out.SecondaryCredentialsRef
		*out = new(v1.SecretReference)
		**out = **in
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RDMAVPCSpec) DeepCopyInto(out *RDMAVPCSpec) {
	*out = *in
	if in.VPCID != nil {
		in, out := &in.VPCID, &out.VPCID
		*out = new(int)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RDMAVPCSpec.
func (in *RDMAVPCSpec) DeepCopy() *RDMAVPCSpec {
	if in == nil {
		return nil
	}
	out := new(RDMAVPCSpec)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RDMAVPCInterfaceSpec) DeepCopyInto(out *RDMAVPCInterfaceSpec) {
	*out = *in
	if in.SubnetID != nil {
		in, out := &in.SubnetID, &out.SubnetID
		*out = new(int)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RDMAVPCInterfaceSpec.
func (in *RDMAVPCInterfaceSpec) DeepCopy() *RDMAVPCInterfaceSpec {
	if in == nil {
		return nil
	}
	out := new(RDMAVPCInterfaceSpec)
...
func (in *VLANInterface) DeepCopyInto(out *VLANInterface) {
	*out = *in
	...
	if in.IPAMAddressLegacy != nil {
		in, out := &in.IPAMAddressLegacy, &out.IPAMAddressLegacy
		*out = new(string)
		**out = **in
	}
}
...
func (in *VPCCreateOptionsIPv6) DeepCopyInto(out *VPCCreateOptionsIPv6) {
	*out = *in
	...
	if in.AllocationClassLegacy != nil {
		in, out := &in.AllocationClassLegacy, &out.AllocationClassLegacy
		*out = new(string)
		**out = **in
	}
}
...
func (in *VPCCreateOptionsIPv6) DeepCopy() *VPCCreateOptionsIPv6 {
	if in == nil {
		return nil
	}
	out := new(VPCCreateOptionsIPv6)
	in.DeepCopyInto(out)
	return out
}
...
func (in *VPCInterfaceCreateOptions) DeepCopyInto(out *VPCInterfaceCreateOptions) {
	*out = *in
	...
	if in.SubnetIDLegacy != nil {
		in, out := &in.SubnetIDLegacy, &out.SubnetIDLegacy
		*out = new(int)
		**out = **in
	}
	if in.IPv4 != nil {
...
func (in *VPCInterfaceIPv4AddressCreateOptions) DeepCopyInto(out *VPCInterfaceIPv4AddressCreateOptions) {
	*out = *in
	...
	if in.NAT1To1AddressLegacy != nil {
		in, out := &in.NAT1To1AddressLegacy, &out.NAT1To1AddressLegacy
		*out = new(string)
		**out = **in
	}
}
...
func (in *VPCInterfaceIPv6CreateOptions) DeepCopyInto(out *VPCInterfaceIPv6CreateOptions) {
	*out = *in
	...
	if in.IsPublicLegacy != nil {
		in, out := &in.IsPublicLegacy, &out.IsPublicLegacy
		*out = new(bool)
		**out = **in
	}
}
...
func (in *VPCSubnetCreateOptions) DeepCopyInto(out *VPCSubnetCreateOptions) {
	*out = *in
	...
	if in.IPv6Range != nil {
		in, out := &in.IPv6Range, &out.IPv6Range
		*out = make([]VPCSubnetCreateOptionsIPv6, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VPCSubnetCreateOptionsIPv6) DeepCopyInto(out *VPCSubnetCreateOptionsIPv6) {
	*out = *in
	if in.Range != nil {
		in, out := &in.Range, &out.Range
		*out = new(string)
...
func (in *VPCSubnetCreateOptionsIPv6) DeepCopy() *VPCSubnetCreateOptionsIPv6 {
	if in == nil {
		return nil
	}
	out := new(VPCSubnetCreateOptionsIPv6)
	in.DeepCopyInto(out)
	return out
}
