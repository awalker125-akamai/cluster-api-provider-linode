...
func (in *AdditionalVPCSpec) DeepCopyInto(out *AdditionalVPCSpec) {
	*out = *in
	if in.VPCID != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AdditionalVPCSpec.
func (in *AdditionalVPCSpec) DeepCopy() *AdditionalVPCSpec {
	if in == nil {
		return nil
	}
	out := new(AdditionalVPCSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *LinodeMachineSpec) DeepCopyInto(out *LinodeMachineSpec) {
	*out = *in
	...
	if in.AdditionalVPCs != nil {
		in, out := &in.AdditionalVPCs, &out.AdditionalVPCs
		*out = make([]AdditionalVPCSpec, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
